...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=()' },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clerk.accounts.dev https://clerk.caliber3d.mx https://challenges.cloudflare.com",
      ...
      "worker-src blob:",
      "connect-src 'self' https://cdn.sanity.io https://*.api.sanity.io https://*.clerk.accounts.dev https://clerk.caliber3d.mx https://api.clerk.com wss://*.clerk.accounts.dev wss://clerk.caliber3d.mx https://challenges.cloudflare.com https://clerk-telemetry.com",
