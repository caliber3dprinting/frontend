      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            {config.address && (
              <p className="text-zinc-400 text-xs mt-3 flex items-start gap-1.5">
                <svg aria-hidden="true" className="w-3.5 h-3.5 mt-0.5 shrink-0" viewBox="0 0 20 20" fill="currentColor">
          ...
          {/* Recursos — categorías dinámicas del blog */}
          {categories.length > 0 && (
            <div>
              <h3 className="text-xs font-semibold text-zinc-400 uppercase tracking-widest mb-4">
                Recursos
            ...
            <ul className="space-y-3">
              ...
              {config.contact_email && (
                <li>
                  ...
                  >
                    <svg aria-hidden="true" className="w-4 h-4 shrink-0" viewBox="0 0 20 20" fill="currentColor">
              ...
              {config.business_hours && (
                <li className="text-sm text-zinc-400 flex items-start gap-2.5">
