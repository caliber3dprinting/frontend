        ...
        <>
          ...
          >
            <div className="relative w-full max-w-lg bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 shadow-2xl">
              ...
              {/* Header */}
              <div className="bg-zinc-950 px-5 pt-4 pb-3 text-center border-b border-zinc-800">
                <p className="text-[10px] font-bold tracking-[0.2em] text-orange-500 uppercase mb-0.5">
                  ⚽ Edición Especial Mundial 2026 🏆
                </p>
                <h2 className="text-xl font-black uppercase tracking-wide text-white leading-tight">
                  Copa del Mundo
                </h2>
                <p className="text-zinc-500 text-[10px] mt-0.5">Impresión 3D · Alta calidad · Envío disponible</p>
              </div>
              ...
              <div className="grid grid-cols-4 gap-1.5 px-3 pb-2">
                {PRODUCTS.map((p) => (
                  <div
                    key={p.id}
                    className="group relative bg-zinc-800 rounded-lg overflow-hidden border border-zinc-700 hover:border-orange-500 transition-all duration-200"
                  >
                    <div className="relative aspect-square w-full">
                      <Image
                        ...
                        sizes="25vw"
                      />
                      <span className="absolute top-1 left-1 text-[9px] font-bold bg-orange-500 text-white px-1 py-0.5 rounded-full uppercase tracking-wide leading-none">
                        {p.tag}
                      </span>
                    </div>
                    <div className="px-1 py-1.5 text-center">
                      <p className="text-orange-500 font-black text-xs leading-none">{p.price}</p>
                      {p.size && <p className="text-zinc-500 text-[9px] mt-0.5">{p.size}</p>}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="px-3 pb-3 pt-0 text-center">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1db954] text-white font-bold px-5 py-2.5 rounded-xl transition-colors text-sm"
                >
